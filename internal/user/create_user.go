...
func (req CreateUserReq) Valid(ctx context.Context) validator.Evaluator {
	...
	eval.CheckField(validator.NotBlank(req.UserName),
		"user_name",
		"this field cannot be empty",
	)

	eval.CheckField(validator.NotBlank(req.Email),
		"email",
		"this field cannot be empty",
	)

	eval.CheckField(validator.NotBlank(req.Bio),
		"bio",
		"this field cannot be empty",
	)
	...
	eval.CheckField(validator.MinChars(req.Password, 8),
		"password",
